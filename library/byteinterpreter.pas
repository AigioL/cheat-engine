  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (variabletype=vtCustom) and (customtype<>nil) and customtype.scriptUsesString then
        begin
        end
        else if (variabletype=vtCustom) and (customtype<>nil) and customtype.scriptUsesFloat then
        begin
          s:=StrToFloat(value);
        end
        else
