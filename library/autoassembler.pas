...
begin
  ...
  begin
    ...
    aobscanmodules[i].memscan.ScanOption:=soExactValue;
    aobscanmodules[i].memscan.Roundingtype:=rtRounded;
    aobscanmodules[i].memscan.Scanvalue2:='';
    aobscanmodules[i].memscan.Startaddress:=aobscanmodules[i].minaddress;
    aobscanmodules[i].memscan.Stopaddress:=aobscanmodules[i].maxaddress;
    aobscanmodules[i].memscan.Hexadecimal:=true;
    aobscanmodules[i].memscan.BinaryStringAsDecimal:=false;
    aobscanmodules[i].memscan.Unicode:=false;
    aobscanmodules[i].memscan.Casesensitive:=false;
    aobscanmodules[i].memscan.Fastscanmethod:=fsmNotAligned;

    if length(aobscanmodules[i].entries)=1 then
    begin
      aobscanmodules[i].memscan.VarType:=vtByteArray;
      aobscanmodules[i].memscan.Scanvalue1:=aobscanmodules[i].entries[0].aobstring;
    end
    else
    begin
      aobscanmodules[i].memscan.VarType:=vtByteArrays;
      aobscanmodules[i].memscan.Scanvalue1:=aobstrings;
    end;

    aobscanmodules[i].memscan.FirstScan;
  end;
