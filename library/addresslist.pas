...
function Taddresslist.descriptioncomparecasesensitive(a: tmemoryrecord; b: tmemoryrecord): integer;
begin
...
begin
  ...
  if ssCtrl in GetKeyShiftState then
    sort(treeview.items[0], descriptioncomparecasesensitive, descriptionsortdirection)
  else
